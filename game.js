...
var user_car_position = 400, user_car_top = 510, level_up_position = 200;
var game_duration, game_level = 1, elapsed_seconds, elapsed_minutes;
var level_label, timer_label, boom_image, msg;
var game_music, game_over_music, level_up_music;

function play_music(tag_id, file_name, loop) {
    var player = document.getElementById(tag_id);
    player.autoplay = true;
    player.loop = loop;
    player.src = file_name;
    player.play();
    
}

function pause_music(tag_id) {
    var player = document.getElementById(tag_id);
    player.pause();
}
...
function game_over() {
    ...
    pause_music("game-music");
    var player = new Audio("sounds/game-over.mp3");
    player.play();
...
function generate_timer() {
    ...
    if(Math.floor(elapsed_seconds) == 60) {
        ...
        var player = new Audio("sounds/level-up.mp3");
        player.play();
...
function start_game() {
    ...
    change_button_value("start_button", "Start");
    play_music("game-music", "sounds/game.wav", true);
}
